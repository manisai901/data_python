...
DATA_PATH = '/opt/airflow/data/weather_data_Vuyyuru.csv'
CITY = 'Vuyyuru'
...
with DAG(
    dag_id='weather_api_etl_Vuyyuru',
    default_args=default_args,
    description='Fetch daily weather data from wttr.in API from vuyyuru',
    schedule='@daily',
    start_date=datetime(2025, 10, 1),
    catchup=False,
    tags=['api', 'etl', 'weather', 'Vuyyuru']
) as dag:
